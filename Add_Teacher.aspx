            ...
            <table>
                <tr>
                    <td class="auto-style2">
                        Teacher ID</td>
                    <td> <asp:TextBox ID="id" runat="server" ForeColor="Salmon" BorderColor="SlateBlue" style="width: 168px"></asp:TextBox></td>
                ...
                <tr>
                    <td class="auto-style2">
                        Username</td>
                    <td>
                        <asp:TextBox ID="name" runat="server" ForeColor="Salmon" BorderColor="RoyalBlue" ErrorMessage="Please Enter Your Username" ></asp:TextBox></td>
                ...
                <tr>
                    <td class="auto-style2">
                        Password</td>
                    <td>
                        <asp:TextBox ID="password" runat="server" TextMode="Password" BorderColor="Salmon" ForeColor="Salmon" ErrorMessage="Please Enter Your Password" ></asp:TextBox></td>
                </tr>
                ...
                <br />
                <br />
<asp:Button ID="Add" runat="server" Text="Add Teacher" BackColor="Salmon" ForeColor="White" BorderStyle="Solid" OnClick="Add_Student" Width="138px"></asp:Button>
 <br />
                <br />
                <br />
